...
<body>
	...
	<?php
		...
		{
			$sql="SELECT books.id,name,author,category,issue,issue_book.return FROM issue_book inner join books ON issue_book.bid=books.id WHERE issue_book.approve = 'YES' AND issue_book.username = '$_SESSION[login_user]' ORDER BY `issue_book`.`return` ASC";
