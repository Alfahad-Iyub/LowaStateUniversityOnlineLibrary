...
<html>
    ...
    <body>
	    		...
	    		<div class="registrationbox">
		    		<div class="registration">
		    			...
		    			<form name="registration" action="" method="post" style="margin-top: 40px; margin-left: 50px"><!-- input boxes -->
		    				...
		    				<input class="btn btn-warning" type="submit" name="submit" value="Submit" style="width: 100px;"><!-- submit button to save details-->
		    			</form>
		    		</div>
		    	</div>
	    	</section>
			...
			<?php
				...
				{
					mysqli_query($db,"INSERT INTO `admin_details` VALUES('', '$_POST[firstname]', '$_POST[lastname]', '$_POST[dateofbirth]', '$_POST[gender]', '$_POST[contactno]', '$_POST[email]', '$_POST[username]', '$_POST[password]');");//query to insert data into the database table
				?>
				<script type="text/javascript">
					alert("Registration Successfull!");//alert box
				</script>
				<?php
				}
			?>
