...
<html>
    ...
    <head>
	    ...
	    <link rel="stylesheet" type="text/css" href="Style.css"><!-- lik to css stylesheet-->
	    <meta charset="utf-8">
	    	...
	    	<section>
	    		...
	    		<div class="wrapper1">
	    				...
	    				if (isset($_POST['submit1']))//if the button is pressed
	    				{
	    					?>
	    						...
	    						<script type="text/javascript">
	    							window.location="Edit.php"//ransport to respective location
	    						</script>

	    					<?php
	    				}

	    				$q=mysqli_query($db,"SELECT * FROM student_details WHERE username='$_SESSION[login_user]' ;");//query to select data from the database maching the logged in usrand assign inside a variable
	    			...
	    			<?php
	    				...
	    				$row=mysqli_fetch_assoc($q);//display feteched data from the variable
